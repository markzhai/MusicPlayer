...
public abstract class MyButton {	
	...
	public MyButton(MusicPlayer parent, PImage image, PImage imageHot, PImage imagePressed, PImage imagePressedHot) {
	...
	public MyButton(MusicPlayer parent, PImage image, PImage imageHot, PImage imagePressed, PImage imagePressedHot, float x, float y, float width, float height){
		this.setParent(parent);
		this.setImage(image);
		this.setImageHot(imageHot);
		this.setImagePressed(imagePressed);
